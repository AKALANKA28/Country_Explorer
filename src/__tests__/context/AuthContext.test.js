...
describe('AuthContext', () => {
  ...
  test('loads user from localStorage on init', async () => {
    ...
    expect(screen.getByTestId('user-status')).toHaveTextContent('Logged in as stored@example.com');
  });
  ...
  test('provider prevents children from rendering while loading', () => {
    ...
    render(
      <CustomAuthProvider>
        <div data-testid="child-content">This should not render during loading</div>
      </CustomAuthProvider>
    );
